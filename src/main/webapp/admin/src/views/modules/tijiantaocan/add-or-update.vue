<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="套餐项目数" prop="taocanxiangmushu">
          <el-input v-model="ruleForm.taocanxiangmushu" 
              placeholder="套餐项目数" clearable  :readonly="ro.taocanxiangmushu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="套餐项目数" prop="taocanxiangmushu">
              <el-input v-model="ruleForm.taocanxiangmushu" 
                placeholder="套餐项目数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fenlei = true;
          ...
          if(o=='taocanxiangmushu'){
            this.ruleForm.taocanxiangmushu = obj[o];
	    this.ro.taocanxiangmushu = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.tijianneirong = this.ruleForm.tijianneirong.replace(reg,'../../../ssm697vf/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
